...
export type PanelId = 'projects' | 'notebooks' | 'methodtab' | 'stack' | 'background';
...
export interface NotebookReportItem {
  theme: string;
  title: string;
  result: string;
  methods: string[];
...
export interface HomeContent {
  ...
  notebookReports: NotebookReportItem[];
  contact: {
    eyebrow: string;
    title: string;
    accent: string;
...
export const homeContent: Record<'en' | 'pt', HomeContent> = {
  en: {
    ...
    tabs: {
      ...
      buttons: [
        ...
        { id: 'notebooks', label: 'Notebook reports' },
    ...
    notebookReports: [
      {
        theme: 'Bayesian pharmacovigilance',
  ...
  pt: {
    ...
    notebookReports: [
      {
        theme: 'Farmacovigilância bayesiana',
        title: 'GLP-1 Bayesian Pharmacovigilance',
